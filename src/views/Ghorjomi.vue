  ...
  <div class="container-fluid main-background bg-image">
    <div class="card card-container shadow border-0 rounded-3 my-3">
      <div class="card-header border-0">
        <h3 class="mt-2 fw-bold">ღორჯომი-ბახმარო</h3>
        <router-link
      ...
      <div class="card-body p-0 border-0">
        ...
        <div class="form-group p-3">
          <div class="row">
            <div class="col-md-6">
              <label for="horsePrice">ცხენის ქირაობა</label>
              <input
                type="text"
                id="horsePrice"
                class="form-control"
                v-model.number="horsePrice"
              />
            </div>
            <div class="col-md-6">
              <label for="horseTotal">ცხენის ფასი ჯამში</label>
              <input
                type="text"
                id="horseTotal"
                class="form-control"
                v-model.number="horseTotal"
                disabled
              />
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    horseTotal() {
      return ((this.horsePrice * this.touristCount) / 0.784).toFixed(2);
    },
    additionalServiceTotal() {
